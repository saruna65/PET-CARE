                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-3">
                            ...
                            <button type="button" id="predictButton" class="px-4 py-2 bg-blue-600 text-white rounded-md disabled:bg-blue-300" disabled>
                                Analyze Image
                            </button>
                            
                            <div class="mt-4">
                                <div id="imagePreview" class="mt-2" style="max-width: 300px; max-height: 300px;"></div>
    ...
    <script type="text/javascript">
        ...
        async function predict() {
            ...
            try {
                ...
                labelContainer.innerHTML = '<div class="text-red-500">Error analyzing image: ' + error.message + '</div>';
            } finally {
                loadingIndicator.classList.add('hidden');
                predictButton.disabled = false;
            }
